...
func (State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_test_cf54b8462ccc4096, []int{0}
}
...
func (Void) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_test_cf54b8462ccc4096, []int{1}
}
...
func _Person_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Person_Sibling:
		...
		if err := b.EncodeMessage(x.Sibling); err != nil {
			return err
		}
	case *Person_Child:
	...
	case *Person_None:
		...
		b.EncodeVarint(uint64(x.None))
	case nil:
	default:
		return fmt.Errorf("Person.Relative has unexpected type %T", x)
	}
	return nil
}
...
func _Person_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Person)
	switch tag {
	case 9: // relative.parent
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Person)
		err := b.DecodeMessage(msg)
		m.Relative = &Person_Parent{msg}
		return true, err
	case 10: // relative.sibling
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Person)
		err := b.DecodeMessage(msg)
		m.Relative = &Person_Sibling{msg}
		return true, err
	case 11: // relative.child
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Person)
		err := b.DecodeMessage(msg)
		m.Relative = &Person_Child{msg}
		return true, err
	case 12: // relative.none
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.Relative = &Person_None{Void(x)}
		return true, err
	default:
		return false, nil
	}
...
func _Person_OneofSizer(msg proto.Message) (n int) {
	...
	case *Person_None:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(x.None))
	case nil:
	default:
...
func (*WellKnowns) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_cf54b8462ccc4096, []int{2}
}
...
func (dst *WellKnowns) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WellKnowns.Merge(dst, src)
}
...
func (*NumbersNumbersNumbers) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_cf54b8462ccc4096, []int{3}
}
...
func (dst *NumbersNumbersNumbers) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NumbersNumbersNumbers.Merge(dst, src)
}
...
func (*Arrays) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_cf54b8462ccc4096, []int{4}
}
...
func (dst *Arrays) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Arrays.Merge(dst, src)
}
...
func (*Maps) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_cf54b8462ccc4096, []int{5}
}
...
func (*TestMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_cf54b8462ccc4096, []int{6}
}
...
func (*TestMessage_Misc) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_cf54b8462ccc4096, []int{6, 0}
}
...
func (dst *TestMessage_Misc) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TestMessage_Misc.Merge(dst, src)
}
...
func init() { proto.RegisterFile("test.proto", fileDescriptor_test_cf54b8462ccc4096) }

var fileDescriptor_test_cf54b8462ccc4096 = []byte{
